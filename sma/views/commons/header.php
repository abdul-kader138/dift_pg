...
<?php if ($this->ion_auth->in_group(array('owner', 'admin'))) { ?>
                        <ul class="menu nav nav-tabs nav-stacked">
                            ...
                            <li class="dropdown"><a class="showSubMenus" href="#transfersMenu"><i class="icon-random icon-white"></i> Inventories <b class="caret"></b></a>
                                <ul class="nav nav-tabs nav-stacked sub-menu" id="transfersMenu">
                                    <li><a href="<?php echo base_url(); ?>index.php?module=reports&view=custom_products">Current Stock</a></li>
                                    <li><a href="<?php echo base_url(); ?>index.php?module=reports&view=opening_stock">Opening & Closing Stock</a></li>
                                    ...
                                    <li><a href="<?php echo base_url(); ?>index.php?module=products&view=view_adjustment">Adjustment Quantity</a></li>
                                    <li><a href="<?php echo base_url(); ?>index.php?module=inventories&view=add_quantity">Count Quantity</a></li>
                                     <li><a href="<?php echo base_url(); ?>index.php?module=reports&view=quantity_variance">Count Variance Quantity</a></li>
                                </ul>
                            </li> 
                            <li class="dropdown"><a class="showSubMenus" href="#purchasesMenu"><i class="icon-star icon-white"></i> <?php echo $this->lang->line('purchases'); ?> <b class="caret"></b></a>
                                <ul class="nav nav-tabs nav-stacked sub-menu" id="purchasesMenu">
                                    <li><a href="<?php echo base_url(); ?>index.php?module=inventories">List Purchases Requisition</a></li>
                                ...
                                <li class="dropdown"><a class="showSubMenus" href="#settingsMenu"><i class="icon-cog  icon-white"></i> <?php echo $this->lang->line('settings'); ?> <b class="caret"></b></a>
                                    <ul class="nav nav-tabs nav-stacked sub-menu" id="settingsMenu">
                                        ...
                                        <li><a href="<?php echo base_url(); ?>index.php?module=settings&amp;view=upload_biller_logo"><?php echo $this->lang->line('upload_biller_logo'); ?></a></li>
                                                 <li class="divider"></li>
                                        <li><a href="<?php echo base_url(); ?>index.php?module=shelfs"><?php echo $this->lang->line('list_shelfs'); ?></a></li>
                                        <li><a href="<?php echo base_url(); ?>index.php?module=shelfs&amp;view=add"><?php echo $this->lang->line('new_shelf'); ?></a></li>
                                        <li class="divider"></li>
                                        
                                        <li><a href="<?php echo base_url(); ?>index.php?module=shelfs&view=racks">Rack List</a></li>
                                        <li><a href="<?php echo base_url(); ?>index.php?module=shelfs&view=add_rack">Add New Rack</a></li>
                                        <li class="divider"></li>
                                        ...
                                        <li><a href="<?php echo base_url(); ?>index.php?module=categories&amp;view=subsubcategories">List Of Sub Subcategory</a></li>
                                        
                                        <li><a href="<?php echo base_url(); ?>index.php?module=categories&amp;view=add_subsubcategory">Add Sub Subcategory</a></li>
