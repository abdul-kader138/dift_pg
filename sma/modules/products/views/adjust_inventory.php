...
<?php if($message) { echo "<div class=\"alert alert-error\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>" . $message . "</div>"; } ?>
	...
	<?php $attrib = array('class' => 'form-horizontal'); echo form_open_multipart("module=products&view=save_adjust_inventory&id=".$id, $attrib); ?>
...
<div class="control-group">
  ...
  <div class="controls"> <?php echo form_input('aj_quantity', $product->adjust_qnt, 'class="span4 tip" id="size" title="Adjustment" required="required" '); ?>
