...
*/
   ...
   function getSales()
   {
		...
		if($this->input->get('paid_by')){ $paid_by = $this->input->get('paid_by'); } else { $paid_by = NULL; }
		if($start_date) {
	   ...
	   $this->datatables
			...
			if($paid_by) { $this->datatables->where('sales.paid_by = ', $paid_by); }
...
';
   ...
   function getVariance()
   {
       ...
       if($product) { $this->datatables->where('count_products.created_at', $start_date); }
