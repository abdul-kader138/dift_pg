...
<div id="wrapper">
    ...
    <table class="table" cellspacing="0"  border="0">
        ...
        <tr>
            ...
            <th style="text-align:left; width:50px;">Invoice No.</th>
        ...
        <?php $r = 1; $totalCount=0;$getBuy = 0;$totalVat=0; foreach ($rows as $row):?>
            <tr>
                <td style="text-align:center; width:10px;"><?php echo $r; ?></td>
                <td style="text-align:left; width:50px;"><?php echo $row->reference_no; ?></td>
                <td style="text-align:center; width:30px;"><?php echo $row->quantity; ?></td>
                <td style="text-align:right; width:50px;"><?php echo $this->ion_auth->formatMoney($row->gross_total); ?></td>
            </tr>
            <?php
