...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#show").click(function(){
            ...
            console.log(sDate);
            window.open("index.php?module=reports&view=pos_view_product&sDate=" +sDate+'&eDate='+eDate, 'MyWindow','toolbar=0,location=0,directories=0,status=0,menubar=yes,scrollbars=yes,resizable=yes,width=1000,height=600');
        })
    });
