...
<?php if($this->session->set_flashdata('success_message')) { echo "<div class=\"alert alert-success\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>" . $this->session->set_flashdata('success_message') . "</div>"; } ?>
...
<div class="control-group">
    ...
    <div class="controls"> <?php echo form_input('product_name', (isset($_POST['product_name']) ? $_POST['product_name'] : $product_name), 'class="span4 tip" id="product_name" required="required" data-error="' . $this->lang->line("product_name") . ' ' . $this->lang->line("is_required") . '"'); ?> </div>
</div>
